...
(function(f) {
    void 0 === f.fn.inputmask && (f.inputmask = {defaults: {placeholder: "_", optionalmarker: {start: "[", end: "]"}, escapeChar: "\\", mask: null, oncomplete: f.noop, onincomplete: f.noop, oncleared: f.noop, repeat: 0, greedy: !0, autoUnmask: !1, clearMaskOnLostFocus: !0, insertMode: !0, clearIncomplete: !1, aliases: {}, onKeyUp: f.noop, onKeyDown: f.noop, showMaskOnFocus: !0, showMaskOnHover: !0, onKeyValidation: f.noop, skipOptionalPartCharacter: " ", numericInput: !1, radixPoint: "", rightAlignNumerics: !0, definitions: {9: {validator: "[0-9]",
        ...
        function l(a) {
            ...
            return f.map(a.split(""), function(a) {
                ...
                if (a === h.escapeChar)
                    c =
                            !0;
                else if (a === h.optionalmarker.start && !c)
                    d = b = !0;
                else if (a === h.optionalmarker.end && !c)
                    b = !1, d = !0;
                else {
                    ...
                    if (e && !c) {
                        ...
                        s.push({fn: null, cardinality: 0, optionality: b, newBlockMarker: d, offset: 0, casing: null, def: a}), c = !1;
                    d = !1;
                    return s;
                }
            });
        ...
        function I(a, b, c, e, d) {
            function j(a, g) {
                for (var d = F(a), f = b ? 1 : 0, s = "", l = g.tests[d].cardinality; l > f; l--)
                    s += D(c, d - (l - 1));
                b && (s += b);
                return null !=
            ...
            f.each(q, function(e) {
                ...
                var g = a;
                if (k != o && !B(a)) {
                    if (b == this._buffer[g] || b == h.skipOptionalPartCharacter)
                        return l[e] = {refresh: !0}, this.lastValidPosition = g, !1;
                    g = d ? M(c, a) : A(c, a)
                }
                if ((void 0 == this.lastValidPosition || d || h.numericInput ? this.lastValidPosition <= h.numericInput ? r(c) : A(c, g) : this.lastValidPosition >= M(c, g)) && 0 <= g && g < r(c))
                    l[e] = j(g, this), !1 !== l[e] ? (!0 === l[e] && (l[e] = {pos: g}), this.lastValidPosition = l[e].pos || g) : this.lastValidPosition =
            ...
            for (var g = m = -1, p, C = j.length, t = 0 == C ? l : -1, x = 0; x < C; x++)
                for (var v = g + 1; v < l; v++)
                    if (B(v)) {
                        ...
                        break
                    } else if (O(b, v), m == g && (m = v), g = v, j[x] == D(b, v))
                        break;
            if (!1 == q[o].greedy) {
                x = U(b.join(""), d).split("");
                j = x.length;
        ...
        function p(a, b, d) {
            ...
            if ("number" == typeof b)
                f(a).is(":visible") && (d = "number" == typeof d ? d : b, !1 == h.insertMode && b == d && d++, j.setSelectionRange ?
        ...
        function P(a) {
            ...
            function d(a) {
                ...
                if (b && b.get)
                    a._valueGet || (a._valueGet = b.get, a._valueSet = b.set, Object.defineProperty(a, "value", {get: function() {
                    ...
                    a._valueGet || (a._valueGet = a.__lookupGetter__("value"), a._valueSet = a.__lookupSetter__("value"), a.__defineGetter__("value", function() {
                        var a = f(this), b = f(this).data("inputmask"), c = b.masksets, d = b.activeMasksetIndex;
                        return b && b.autoUnmask ? a.inputmask("unmaskedvalue") : this._valueGet() != c[d]._buffer.join("") ? this._valueGet() : ""
                        ...
                        (a._valueGet = function() {
                            ...
                            this.value = a
                        }), !0 != f.fn.val.inputmaskpatch)
                    f.fn.val = function() {
                        if (arguments.length == 0) {
                            var a = f(this);
                            if (a.data("inputmask")) {
                                if (a.data("inputmask").autoUnmask)
            ...
            function l(a, b, c) {
                ...
                for (var d = a; d < b && d < r(g); d++)
                    if (B(d)) {
                        ...
                        var e = A(g, d), j = D(g, e);
                        if (j != G(e))
                            if (e < r(g) && !1 !== I(d, j, g, !0, w) && z()[F(d)].def == z()[F(e)].def)
                                J(g, d, D(g, e)), O(g, e);
                            else {
                                if (B(d))
                                    break
            ...
            function u(a, b, c, d) {
                for (; a <= b && a < r(g); a++)
                    if (B(a)) {
                        ...
                        if (e != G(a))
                            if (c = A(g, a), c < r(g))
                                if (!1 !== I(c, e, g, !0, w) && z()[F(a)].def == z()[F(c)].def)
                                    c = e;
                                else if (B(c))
                                    break;
                                else
            ...
            function y(a) {
                ...
                if (c == h.keyCode.BACKSPACE || c == h.keyCode.DELETE ||
                        aa && 127 == c) {
                    var e = r(g);
                    if (0 == d.begin && d.end == e)
                        o = 0, g = k().slice(), H(b, g), p(b, C(b, g, !1));
                    else if (1 < d.end - d.begin || 1 == d.end - d.begin && h.insertMode)
                        X(g, d.begin, d.end), T(g, d.begin, o), H(b, g, w ? C(b, g, !1) : d.begin);
                    else {
                        var n = $ ? d.end : d.begin;
                    ...
                    c == h.keyCode.END || c == h.keyCode.PAGE_DOWN ? setTimeout(function() {
                        var c = C(b, g, !1, !0);
            ...
            if (t.is(":input")) {
                ...
                M(g, r(g));
                var w = !1;
                if ("rtl" == a.dir || h.numericInput)
                    ("rtl" == a.dir || h.numericInput && h.rightAlignNumerics) && t.css("text-align", "right"), a.dir = "ltr", t.removeAttr("dir"), L = t.data("inputmask"), L.isRTL = !0, t.data("inputmask", L), w = !0;
                t.unbind(".inputmask");
        ...
        if ("string" == typeof a)
            ...
            if ("object" == typeof a)
                return h = f.extend(!0, {}, f.inputmask.defaults, a), b(h.alias, a), q = u(), this.each(function() {
                    P(this)
                });
            if (void 0 == a)
                return this.each(function() {
...
(function(f) {
    ...
    f.extend(f.inputmask.defaults.aliases, {url: {mask: "ir", placeholder: "", separator: "", defaultPrefix: "http://", regex: {urlpre1: /[fh]/, urlpre2: /(ft|ht)/, urlpre3: /(ftp|htt)/, urlpre4: /(ftp:|http|ftps)/, urlpre5: /(ftp:\/|ftps:|http:|https)/, urlpre6: /(ftp:\/\/|ftps:\/|http:\/|https:)/, urlpre7: /(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/)/,
                urlpre8: /(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/\/)/}, definitions: {i: {validator: function() {
                            ...
                            a[d] = function() {
                                ...
                                return{validator: function(d, b, j, f, u) {
                                        if (u.regex["urlpre" + (a + 1)]) {
                                            ...
                                            if (!f && !d) {
                                                j -= a;
                                                for (f = 0; f < u.defaultPrefix.length; f++)
                                                    b[j] = u.defaultPrefix[f], j++;
                        ...
                        return a
                    }()}}, insertMode: !1, autoUnmask: !1}, ip: {mask: "i.i.i.i", definitions: {i: {validator: "25[0-5]|2[0-4][0-9]|[01][0-9][0-9]", cardinality: 3, prevalidator: [{validator: "[0-2]", cardinality: 1}, {validator: "2[0-5]|[01][0-9]", cardinality: 2}]}}}})
})(jQuery);
(function(f) {
    f.extend(f.inputmask.defaults.definitions, {h: {validator: "[01][0-9]|2[0-3]", cardinality: 2, prevalidator: [{validator: "[0-2]", cardinality: 1}]}, s: {validator: "[0-5][0-9]", cardinality: 2, prevalidator: [{validator: "[0-5]", cardinality: 1}]}, d: {validator: "0[1-9]|[12][0-9]|3[01]", cardinality: 2, prevalidator: [{validator: "[0-3]", cardinality: 1}]}, m: {validator: "0[1-9]|1[012]", cardinality: 2, prevalidator: [{validator: "[01]", cardinality: 1}]}, y: {validator: "(19|20)\\d{2}", cardinality: 4, prevalidator: [{validator: "[12]",
    ...
    f.extend(f.inputmask.defaults.aliases, {"dd/mm/yyyy": {mask: "1/2/y", placeholder: "dd/mm/yyyy", regex: {val1pre: /[0-3]/, val1: /0[1-9]|[12][0-9]|3[01]/, val2pre: function(a) {
            ...
            definitions: {1: {validator: function(a, d, c, e, b) {
                        ...
                        if (!e && !j && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
                            if (j = b.regex.val1.test("0" + a.charAt(0)))
                                return d[c - 1] = "0", {pos: c, c: a.charAt(0)};
                        return j
                    }, cardinality: 2, prevalidator: [{validator: function(a, d, c, e, b) {
                                var j = b.regex.val1pre.test(a);
                                return!e && !j && (j = b.regex.val1.test("0" + a)) ? (d[c] = "0", c++, {pos: c}) : j
                            }, cardinality: 1}]}, 2: {validator: function(a, d, c, e, b) {
                        var j = d.join("").substr(0, 3), f = b.regex.val2(b.separator).test(j +
                                a);
                        if (!e && !f && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
                            if (f = b.regex.val2(b.separator).test(j + "0" + a.charAt(0)))
                                return d[c - 1] = "0", {pos: c, c: a.charAt(0)};
                        return f
                    }, cardinality: 2, prevalidator: [{validator: function(a, d, c, e, b) {
                            ...
                            }, cardinality: 1}]}, y: {validator: function(a, d, c, e, b) {
                        ...
                        return!1
                    }, cardinality: 4, prevalidator: [{validator: function(a, d, c, e, b) {
                                ...
                                if (!e && !f) {
                                    ...
                                    if (f = b.isInYearRange(e + a, b.yearrange.minyear, b.yearrange.maxyear))
                                        return d[c++] = e[0], {pos: c};
                                    ...
                                    if (f = b.isInYearRange(e +
                                        ...
                                        return d[c++] = e[0], d[c++] = e[1], {pos: c}
                                }
                                return f
                            }, cardinality: 1}, {validator: function(a, d, c, e, b) {
                                var f = b.isInYearRange(a, b.yearrange.minyear, b.yearrange.maxyear);
                                if (!e && !f) {
                                    e = b.determinebaseyear(b.yearrange.minyear, b.yearrange.maxyear).toString().slice(0, 2);
                                    if (f = b.isInYearRange(a[0] + e[1] + a[1], b.yearrange.minyear, b.yearrange.maxyear))
                                        return d[c++] = e[1], {pos: c};
                                    e = b.determinebaseyear(b.yearrange.minyear, b.yearrange.maxyear).toString().slice(0, 2);
                                    b.isInYearRange(e +
                                    ...
                                    if (f)
                                        return d[c - 1] = e[0], d[c++] = e[1], d[c++] = a[0], {pos: c}
                                }
                                return f
                            }, cardinality: 2}, {validator: function(a, d, c, e, b) {
            ...
            onKeyUp: function(a, d, c) {
                ...
                a.ctrlKey && a.keyCode == c.keyCode.RIGHT && (a = new Date, d.val(a.getFullYear().toString() + (a.getMonth() + 1).toString() + a.getDate().toString()))
                        ...
                        if (!e && !l && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))
                            if (l = b.regex.val2(b.separator).test(f + "0" + a.charAt(0)))
                                return d[c - 1] = "0", {pos: c, c: a.charAt(0)};
                        if (l) {
                            if (d.join("").substr(4, 4) + a != b.leapday)
                                return!0;
                        ...
                        return l
                            ...
                            }, cardinality: 1}]}}}, "dd.mm.yyyy": {mask: "1.2.y", placeholder: "dd.mm.yyyy", leapday: "29.02.", separator: ".", alias: "dd/mm/yyyy"}, "dd-mm-yyyy": {mask: "1-2-y", placeholder: "dd-mm-yyyy", leapday: "29-02-", separator: "-",
            ...
            regex: {hrspre: /[012]/, hrs24: /2[0-9]|1[3-9]/, hrs: /[01][0-9]|2[0-3]/, ampmpre: /[apAP]/, ampm: /^[a|p|A|P][m|M]/}, timeseparator: ":", hourFormat: "24", definitions: {h: {validator: function(a, d, c, e, b) {
                        ...
                        if (!e && !f && (a.charAt(1) == b.timeseparator || -1 != "-.:".indexOf(a.charAt(1))))
                            if (f = b.regex.hrs.test("0" + a.charAt(0)))
                                return d[c - 1] = "0", d[c] = a.charAt(0), c++, {pos: c};
                        return f && "24" !== b.hourFormat && b.regex.hrs24.test(a) ? (a = parseInt(a, 10), d[c + 5] = 24 == a ? "a" : "p", d[c + 6] = "m", a -= 12, 10 > a ? (d[c] = a.toString(),
                            ...
                            }, cardinality: 1}]}, t: {validator: function(a, d, c, e, b) {
                        var f = b.regex.ampm.test(a);
                        return!e && !f && (f = b.regex.ampm.test(a + "m")) ? (d[c - 1] = a.charAt(0), d[c] = "m", c++, c) : f
                    }, casing: "lower", cardinality: 2, prevalidator: [{validator: function(a, d, c, e, b) {
                                if (e = b.regex.ampmpre.test(a))
                                    if (e =
                                            b.regex.ampm.test(a + "m"))
                                        return d[c] = a, d[c + 1] = "m", c;
                                return e
...
(function(f) {
    f.extend(f.inputmask.defaults.aliases, {decimal: {mask: "~", placeholder: "", repeat: 10, greedy: !1, numericInput: !0, digits: "*", groupSeparator: ",", radixPoint: ".", groupSize: 3, autoGroup: !1, getMaskLength: function(a, d, c, e, b) {
                ...
                if (e.autoGroup || c && -1 != b.indexOf(e.groupSeparator)) {
                    for (var b = b.replace(RegExp("\\" + e.groupSeparator, "g"), ""), j = b.split(e.radixPoint), b = j[0], l = RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); l.test(b); )
                        b = b.replace(l, "$1" + e.groupSeparator + "$2"), b = b.replace(e.groupSeparator + e.groupSeparator, e.groupSeparator);
            ...
            regex: {number: function(a, d, c, e) {
                ...
                if (a.keyCode == c.keyCode.TAB) {
                    if (a = f.inArray(c.radixPoint, d), -1 != a) {
                        for (var b = e.data("inputmask").masksets, e = e.data("inputmask").activeMasksetIndex, j = 1; j <= c.digits && j < c.getMaskLength(b[e]._buffer, b[e].greedy, b[e].repeat, d, c); j++)
                            void 0 == d[a + j] &&
                                    (d[a + j] = "0");
                        this._valueSet(d.join(""))
                    }
                } else if (a.keyCode == c.keyCode.DELETE || a.keyCode == c.keyCode.BACKSPACE)
                    c.postFormat(d, 0, !0, c), this._valueSet(d.join(""))
            }, definitions: {"~": {validator: function(a, d, c, e, b) {
                        if ("" == a)
                            return!1;
                        if (1 == c && "0" === d[0] && /[\d-]/.test(a))
                            return d[0] = "", {pos: 0};
                        ...
                        if (!l &&
                            ...
                            for (i = f.length - l; 3 >= i; i++)
                                f += "0";
                            l = b.regex.number(b.groupSeparator, b.groupSize, b.radixPoint, b.digits).test(f);
                            if (!l && !e && a == b.radixPoint && (l = b.regex.number(b.groupSeparator, b.groupSize, b.radixPoint, b.digits).test("0" + f + "0")))
                                return d[c] = "0", c++, {pos: c}
                        }
